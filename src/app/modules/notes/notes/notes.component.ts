...
import { Label, Note } from '../domain/models/notes.types';
import { DetailsComponent } from '../presentation/components/details/details.component';
import { cloneDeep } from 'lodash-es';
import { LabelsComponent } from '../presentation/components/labels/labels.component';
...
@Component({
    selector: 'app-notes',
    imports: [MatSidenavModule, MatRippleModule, NgClass, MatIconModule, NgIf, NgFor, MatButtonModule, MatFormFieldModule, MatInputModule, FuseMasonryComponent, AsyncPipe, NgStyle],
